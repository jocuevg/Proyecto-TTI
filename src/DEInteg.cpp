...
Matrix &DEInteg(Matrix &func(double t, Matrix &y), double t, double tout, double relerr, double abserr, int n_eqn, Matrix &y)
{
    ...
    int kold, ki, i, ifail, k, kp1, kp2, km1, km2, knew, ns, nsp1, realns, im1, reali, nsm2, limit1, nsp2, limit2, ip1;
    double hi, temp1, term, psijm1, gamma, eta, p5eps, round, hold, absh, hnew, sum, erk, erkm1, temp2, temp4, temp5, temp3, temp6, tau, xold, erkm2, err, rho2, erkp1, r;
    bool phase1, crash, nornd, success;
